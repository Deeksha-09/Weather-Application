...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void getPermissionToAccessLocation() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setMessage("This permission is needed in order to get weather data for your current location. Manually enable in Settings > Apps & notifications > WeatherApp > Permissions.")
    ...
    private void sendMail() {
        ...
        sendSmtpEmail.sender(new SendSmtpEmailSender().email("weathershare@nullparams.com").name("WeatherApp"));
